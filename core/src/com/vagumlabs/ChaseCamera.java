...
public class ChaseCamera extends PerspectiveCamera {
    ...
    public void setDesiredOffset(Vector3 desiredOffset) {
    ...
    public Vector3 getDesiredLocation() {
        return desiredLocation;
    }

    public Vector3 getDesiredOffset() {
